...
function FileCard(props: Props) {
  ...
  return (
    <div className="flex flex-col min-w-[120px] max-w-[120px] min-h-[120px] max-h-[120px] cursor-pointer group">
      <div className="flex flex-col px-3 py-2 space-y-2">
        <FaFile className="text-4xl mx-auto group-hover:text-slate-400" />
